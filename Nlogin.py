...
#==============================================================================#
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("ചচ①ღัՁω่❂全Đąѓℜ Ŋɨɠђŧ",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "ചচ①ღัՁω่❂全Đąѓℜ Ŋɨɠђŧ\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
